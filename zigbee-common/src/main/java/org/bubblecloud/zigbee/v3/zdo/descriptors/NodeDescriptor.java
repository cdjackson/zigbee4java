...
public class NodeDescriptor {
    ...
    public enum FrequencyBandType {
        Freq868MHz, Freq902MHz, Freq2400MHz
    }

    public enum ServerCapabilitiesType {
        PrimaryTrustCenter, BackupTrustCenter, PrimaryBindingTableCache, BackupBindingTableCache, PrimaryDiscoveryCache, BackupDiscoveryCache, NetworkManager
    }

    public enum DescriptorCapabilityType {
        ExtendedActiveEnpointList, ExtendedSimpleDescriptor
    }
